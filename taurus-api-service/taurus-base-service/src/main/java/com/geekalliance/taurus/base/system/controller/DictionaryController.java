...
import com.geekalliance.taurus.base.api.system.dto.*;
...
public class DictionaryController extends BaseController {
    ...
    public Result getDictionaryTypes(@RequestBody @Validated QueryDictionaryTypeDTO queryParam) {
    ...
    public Result getDictionaries(@RequestBody @Validated QueryDictionaryDTO queryParam) {
    ...
    public Result add(@RequestBody @Validated(ValidatedGroup.add.class) AddDictionaryDTO saveParam) {
    ...
    public Result update(@RequestBody @Validated(ValidatedGroup.update.class) UpdateDictionaryDTO updateParam) {
